...
def plot_data():
    ...
    zones = [
        ...
        (56, 93, 'Loading (Memcached1)', 'lightblue'),
        (93, 248, 'Pause', 'lightgray'),
       # (49, 60, 'Dump', 'lightgreen'),
       # (60, 70, 'Pause', 'lightgray'),
       # (110, 212, 'Perturbation', 'lightcoral'),
       # (212, 248, 'Pause', 'lightgray'),
        (248, 293, 'Loading (Memcached3 without perturbation)', 'orange'),
