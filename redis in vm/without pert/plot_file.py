...
def plot_data():
    ...
    # without pert
    zones = [
        (0, 54, 'Booting', 'lightyellow'),
        (54, 79, 'Loading (Redis)', 'lightblue'),
        (79, 187, 'Pause', 'lightgray'),
       # (105, 125, 'Swap out V(vic)', 'lightgreen'),
       # (125, 205, 'Pause', 'lightgray'),
       # (136, 185, 'V(dis)', 'lightcoral'),
       # (185, 205, 'Pause', 'lightgray'),
        (187, 216, 'Dump Redis (without perturbation)', 'red'),
        (187, 401, 'Dump Redis (only Guest perturbation)', 'orange'),
        (187, 494, 'Dump (Redis after Guest and host perturbation)', 'lightgreen'),
    ]
