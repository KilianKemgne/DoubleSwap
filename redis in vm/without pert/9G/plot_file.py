...
def plot_data():
    ...
    # without pert
    zones = [
        (0, 56, 'Booting', 'lightyellow'),
        (56, 95, 'Loading (Redis)', 'lightblue'),
        (95, 205, 'Pause', 'lightgray'),
       # (105, 125, 'Swap out V(vic)', 'lightgreen'),
       # (125, 205, 'Pause', 'lightgray'),
       # (136, 185, 'V(dis)', 'lightcoral'),
       # (185, 205, 'Pause', 'lightgray'),
        (205, 535, 'Dump Redis (without perturbation)', 'red'),
        (205, 756, 'Dump Redis (only Guest perturbation)', 'orange'),
        (205, 969, 'Dump (Redis after Guest and host perturbation)', 'lightgreen'),
    ]
