...
def plot_data():
    ...
    # without pert
    zones = [
        (0, 36, 'Booting', 'lightyellow'),
        (36, 43, 'Loading', 'lightblue'),
        (43, 49, 'Pause', 'lightgray'),
        (49, 60, 'Dump', 'lightgreen'),
        (60, 70, 'Pause', 'lightgray'),
        (70, 113, 'Perturbation', 'lightcoral'),
        (113, 120, 'Pause', 'lightgray'),
        (120, 182, 'Dump (Double Swap)', 'lightgreen')
    ]
    ...
    plt.plot(time_in_minutes_mem, memory_usage, label='Memory Usage VM (MB)', color='blue')
    ...
    plt.title('Memory Usage by VM and Disturber')
