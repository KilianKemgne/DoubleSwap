...
for i, line in enumerate(lines):
    ...
    if i < 11:  # Les 10 premières lignes correspondent au premier ensemble
...
plt.plot(percentages_1, times_1, marker='o', linestyle='-', color='b', label="Dump without perturbation")

# Deuxième courbe (Dump avec perturbateur)
plt.plot(percentages_2, times_2, marker='s', linestyle='--', color='r', label="Dump with perturbation")

# Ajout des labels et du titre
plt.xlabel("Percentage of data dumped (%)")
plt.ylabel("Elapsed time (seconds)")
plt.title("Comparison of Redis dump times with and without perturbation (SSD)")
